...
> **Предварительная версия 0.2.0.** Проверена с OMP 18.1.5. Обычный Pi пока не поддерживается. Плагин помогает уменьшить потерю контекста; отсутствие галлюцинаций не гарантирует.
